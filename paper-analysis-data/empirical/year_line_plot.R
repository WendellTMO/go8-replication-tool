...
# REPLICATIONDOCFIX
# NUBANKCRITERIADOCFIX
# VTEXCRITERIADOCFIX

THE_FILE    <- "/home/aluno/ACID-dataset/ARTIFACT/IaC_Defect_Categ_Revamp/output/VTEXCRITERIADOCFIX_YEAR_TEMPORAL_FINAL.csv"
THE_LIMIT   <- 9
THE_DS_NAME <- "vtex"
OUT_FIL     <- "/home/aluno/ACID-dataset/ARTIFACT/IaC_Defect_Categ_Revamp/src_categ_revamp/empirical/vtex-2y-docfix-fig-freq.pdf"
